...
class Dumb:
    ...
    def create_samples(self, points_per_unit=100, equal_size=False):
        ...
        return dumbbell_samples[:samples_till_now]

    def subsample_shape(self, points_per_unit, percent_to_keep, equal_size):
        dumbbell_samples = self.create_samples(points_per_unit, equal_size)
        ...
        return dumbbell_samples[dumbbell_remaining_indices, :], dumbbell_samples[dumbbell_subsample_indices, :]
...
class Circ:
    ...
    def subsample_shape(self, points_per_unit, percent_to_keep, equal_size):
        eye_samples = self.create_samples(points_per_unit, equal_size)
